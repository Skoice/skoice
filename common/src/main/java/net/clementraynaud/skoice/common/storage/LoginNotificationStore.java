...
public class LoginNotificationStore extends ObjectMvStoreFile {

    public static final String NOTIFIED_PLAYERS_ID_FIELD = "notified-players-id";
    public static final String MAP_NAME = "login-notification";

    public LoginNotificationStore(Skoice plugin, MvStore store) {
        super(plugin, store, LoginNotificationStore.MAP_NAME);
    }
}
