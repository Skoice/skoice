...
import static net.clementraynaud.skoice.system.DistanceCalculation.horizontalDistance;
import static net.clementraynaud.skoice.system.DistanceCalculation.verticalDistance;
...
//                    if (log) .error("The bot doesn't have the \"" + permission.getName() + "\" permission in the voice category (" + category.getName() + ")");
            ...
            Set<UUID> oldDirtyPlayers = MarkPlayersDirty.getDirtyPlayers();
            MarkPlayersDirty.clearDirtyPlayers();
