package net.clementraynaud.skoice.platforms.velocity.commands.skoice;
...
import net.clementraynaud.skoice.platforms.velocity.SkoiceVelocity;
import net.clementraynaud.skoice.platforms.velocity.minecraft.VelocityBasePlayer;
import net.clementraynaud.skoice.platforms.velocity.minecraft.VelocityCommandSender;
