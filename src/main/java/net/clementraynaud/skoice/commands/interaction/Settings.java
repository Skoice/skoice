...
import static net.clementraynaud.skoice.commands.interaction.LanguageSelection.*;
...
import static net.clementraynaud.skoice.commands.interaction.ServerSelection.*;
